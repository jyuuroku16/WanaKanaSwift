// Japanese and English punctuation arrays
let JA_PUNC: [String] = [
    "！",
    "？",
    "。",
...
// Conversion tables for romaji to hiragana/katakana and vice versa
let ROMA_TO_HIRA_KATA: [[String]] = [
